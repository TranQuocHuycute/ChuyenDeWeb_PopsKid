          ...
          <div className="absolute lg:relative w-64 shadow bg-gray-100 hidden lg:block">
            ...
            <ul aria-orientation="vertical" className=" py-6">
                <NavLink to={"/dashboard"}>
                  <li className={`pl-6 cursor-pointer text-sm leading-3 tracking-normal pb-4 pt-5 focus:text-indigo-700 focus:outline-none`}>
              ...
              <li className={`pl-6 cursor-pointer text-sm leading-3 tracking-normal mt-4 mb-4 py-2 focus:text-indigo-700 focus:outline-none`}>
