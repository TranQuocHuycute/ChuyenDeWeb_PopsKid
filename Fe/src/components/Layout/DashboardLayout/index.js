              ...
              <div className="absolute lg:relative w-64 shadow bg-gray-100 hidden lg:block">
                ...
                <ul aria-orientation="vertical" className=" py-6">
                  <NavLink to={'/dashboard'}>
                    <li
                      className={`pl-6 cursor-pointer text-sm leading-3 tracking-normal pb-4 pt-5 focus:text-indigo-700 focus:outline-none`}
                    >
                  ...
                  <li
                    className={`pl-6 cursor-pointer text-sm leading-3 tracking-normal mt-4 mb-4 py-2 focus:text-indigo-700 focus:outline-none`}
                  >
                  ...
                  <NavLink to={'/dashboard/categories'}>
                    <li
                      className={`pl-6 cursor-pointer text-sm leading-3 tracking-normal mb-4 py-2 focus:text-indigo-700 focus:outline-none`}
                    >
                      <div className="flex items-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                  ...
                  <NavLink to={'/dashboard/countries'}>
                    <li className="pl-6 cursor-pointer text-sm leading-3 tracking-normal mb-4 py-2 focus:text-indigo-700 focus:outline-none">
                      <div className="flex items-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="icon icon-tabler icon-tabler-compass"
                  ...
                  <NavLink to={'/dashboard/types'}>
                    <li className="pl-6 cursor-pointer text-sm leading-3 tracking-normal py-2 focus:text-indigo-700 focus:outline-none">
                      <div className="flex items-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
