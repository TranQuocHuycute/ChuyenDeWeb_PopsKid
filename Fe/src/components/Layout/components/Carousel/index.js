...
const Carousel = () => {
  ...
  const [videoCate, setVideoCate] = useState([])
  const {key} = useParams()
  console.log(key);
  useEffect(() => {
  ...
  return (
    <div className="carousel mx-6 xl:mx-16 2xl:mx-16 rounded-md">
      ...
      {videoCate.length > 0 &&
        videoCate.map((video) => {
          return (
            <div clasName="relative overflow-hidden rounded-md pt-2">
              <div className="carousel-container relative flex gap-1 overflow-hidden scroll-smooth snap-x snap-mandatory touch-pan-x z-0 rounded-md">
                {/* icon */}
                <div className="mr-2">
                  <svg
              ...
              <div>
                ...
                <div className="relative overflow-hidden rounded-md pt-2">
                  ...
                  >
                    {video.eps.map((resource, index) => {
                      return (
                        <div
                          key={index}
                          className="px-2 pb-20 text-black rounded-md"
                        >
