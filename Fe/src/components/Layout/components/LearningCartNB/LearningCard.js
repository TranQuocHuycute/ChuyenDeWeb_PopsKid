...
export default function LearningCard({
  ...
  return (
    <Link to={`/courseDetails/${id}`}>
      <div key={id} className="pl-2 sm:pl-10 pb-8">
        <div className="pb-16 text-black bg-[#fff] rounded-md">
          <div className="rounded-md">
            <div className="learningcard-item relative w-72 h-[350px] snap-start rounded-md">
              {/* img */}
              <div
              ...
              <div className="pl-5 w-72 ">
                {/* ten khoa hoc */}
                <a className="aspect-square block absolute transition-opacity z-10">
                ...
                {/* detail */}
                <a className="transition-opacity">
                  <h3 className="pt-2 font-normal mx-auto text-sm pr-4 text-[#707070]">
                    {description.slice(0, 105)} ...
                  </h3>
                </a>
              </div>
              <h1 className="font-medium text-center border-t mt-3">
                {formatCash(price + '')} đ / buổi
              </h1>
            </div>
          </div>
        </div>
