        ...
        <div>
          ...
          <div className="slider mx-auto pl-20 rounded-md mb-96 pt-6">
            ...
            <div className="relative overflow-hidden rounded-md">
              <div
                ref={slider}
                className="slider-container relative flex gap-1 overflow-hidden scroll-smooth snap-x snap-mandatory touch-pan-x z-0 rounded-md"
              >
                  ...
                  return (
                    <div className="px-2 pb-10 text-black rounded-md">
                      ...
                      >
                        <a
                          href={resource.link}
                          className="scale-100 hover:scale-95 ease-in duration-100 h-64 w-64 aspect-square block bg-origin-padding bg-left-top bg-cover bg-no-repeat z-0 rounded-md"
                          style={{
