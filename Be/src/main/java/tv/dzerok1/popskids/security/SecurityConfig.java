...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/api/user/course/{username}", "/api/course/addtouser/{courseId}/{username}", "/api/auth/login", "/api/courses/{id}", "/api/courses/catalogs", "/api/courses/search/**","/api/auth/register", "/api/courses/catalogs/{id}", "/api/types", "/api/countries", "/api/courses/{id}/add/teacher", "/api/courses/{id}/add/rating", "/api/categories", "/api/token/refresh", "/api/videos", "/api/videos/{id}", "/api/courses", "/api/search/**", "/api/videos/{videoId}/{epNumber}", "/api/videos/categories/name/{name}").permitAll();
